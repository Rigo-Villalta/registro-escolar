...
class Estudiante(Persona):
    ...
    seccion = models.ForeignKey(
        Seccion, verbose_name="Sección", blank=True, null=True, on_delete=models.SET_NULL)
    ...
    es_autista = models.BooleanField(
        verbose_name="Transtorno del espectro autista")
    ...
    usa_medicamentos = models.BooleanField(
        verbose_name="¿El estudiante toma algún medicamento prescrito permanentemente?", default=False)
    ...
    tipo_de_sangre = models.CharField(
        max_length=3, choices=SANGRE_CHOICES, blank=True)
    ...
    roommate = models.CharField(max_length=1,
                                verbose_name="Personas con quienes vive el estudiante",
                                choices=ROOMMATE_CHOICES, default="P")
    ...
    zona_de_residencia = models.CharField(max_length=1,
                                          choices=[("U", "Urbana"), ("R", "Rural")], default="U")
    ...
    fuente_de_agua = models.CharField(
        max_length=1, choices=AGUA_CHOICES, default="A")
    PISO_CHOICES = [
    ...
    piso = models.CharField(
        ...
        choices=PISO_CHOICES, default="L")
    SANITARIO_CHOICES = [
    ...
    tipo_de_sanitario = models.CharField(
        max_length=1,
        choices=SANITARIO_CHOICES, default="T")
